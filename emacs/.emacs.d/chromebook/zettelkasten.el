...
(setq citeproc-org-default-style-file
      "~/Zotero/styles/american-chemical-society.csl")

(use-package zotra
  :config (setq zotra-default-bibliography "~/Sync/My_Library2.bib"
		zotra-download-attachment-default-directory "~/Sync/Zotero_pdfs"))

(use-package citar
  :config (setq citar-bibliography
		'("~/Sync/My_Library.bib" "~/Sync/My_Library2.bib")
		citar-notes-paths '("~/org_roam/ref")))
...
(use-package org-roam-bibtex
  ...
  :config (setq orb-insert-interface 'ivy-bibtex
		...
		'("citekey" "author" "date" "entry-type" "keywords" "url" "file")))
