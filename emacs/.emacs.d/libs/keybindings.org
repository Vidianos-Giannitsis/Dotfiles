...
** Common Lisp, Clojure and other Programming languages
Common Lisp and Clojure have a lot of useful keybindings inside their major modes. For this reason, I have a seperate section for these
