...
|------------------+------------------------------------------------------------------------------------------------------------------------------------------------------|
| *Dired*            | Dired is the Emacs file manager, below are commands specific to dired (bound to SPC d) or commands to quickly jump to important files                |
|------------------+------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| SPC d u          | Open dired on the current semester's folder                                                                                                          |
| SPC d q          | Open my Qtile config.                                                                                                                                |
|------------------+------------------------------------------------------------------------------------------------------------------------------------------------------|
