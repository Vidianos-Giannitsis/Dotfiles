...
;;; Generated autoloads from ox-blackfriday.el
 (put 'org-blackfriday-special-block-raw-content-types 'safe-local-variable (lambda (x) (stringp x)))
...
;;; Generated autoloads from ox-hugo.el
 ...
 (put 'org-hugo-special-block-raw-content-types 'safe-local-variable (lambda (x) (stringp x)))
