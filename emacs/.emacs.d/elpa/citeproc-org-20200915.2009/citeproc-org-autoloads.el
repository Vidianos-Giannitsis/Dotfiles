;;; citeproc-org-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "citeproc-org" '("citeproc-org-"))
...
Add citeproc-org rendering to the `org-export-before-parsing-hook' hook." t nil)
