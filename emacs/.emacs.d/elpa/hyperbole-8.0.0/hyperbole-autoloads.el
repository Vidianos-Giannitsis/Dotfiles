;;; hyperbole-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "hact" '("act" "defact" "hact" "hrule:action" "htype:create" "sym"))
...
(register-definition-prefixes "hactypes" '("annot-bib" "completion" "display-" "eval-elisp" "exec-" "hyp-" "link-to-" "man-show" "rfc-toc" "text-toc"))
...
(register-definition-prefixes "hbut" '("defal" "defi" "ebut:" "hattr:summarize" "hbut:" "ibtype:" "ibut:" "map-"))
...
(register-definition-prefixes "hinit" '("hyperb:check-dir-user"))
...
(register-definition-prefixes "hpath" '("hpath:"))
...
(register-definition-prefixes "hrmail" '("Rmail-"))
...
Return non-nil iff hyperbole-mode is active and it shares the org-meta-return key binding." nil nil)
...
\(fn REGISTER START END &optional DELETE-FLAG REGION)" t nil)
...
(register-definition-prefixes "hversion" '("hyperb:"))
