...
Popup help about anything at point." t nil)

(autoload 'tss-jump-to-definition "tss" "\
Jump to method definition at point." t nil)

(autoload 'tss-implement-definition "tss" "\
Implement inherited definitions of current component." t nil)

(autoload 'tss-run-flymake "tss" "\
Run check by flymake for current buffer." t nil)

(autoload 'tss-reload-current-project "tss" "\
Reload project data for current buffer." t nil)

(autoload 'tss-restart-current-buffer "tss" "\
Restart TSS for current buffer." t nil)

(autoload 'tss-stop-current-buffer "tss" "\
Stop TSS for current buffer." t nil)

(autoload 'tss-setup-current-buffer "tss" "\
Do setup for using TSS in current buffer." t nil)

(autoload 'tss-config-default "tss" "\
Do setting recommemded configuration." nil nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tss" '("ac-source-tss-" "tss-")))
