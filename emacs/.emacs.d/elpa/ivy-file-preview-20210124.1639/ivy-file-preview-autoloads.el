;;; ivy-file-preview-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ivy-file-preview" '("ivy-file-preview-")))
