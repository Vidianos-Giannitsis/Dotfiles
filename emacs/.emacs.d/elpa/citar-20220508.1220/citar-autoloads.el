...
(with-eval-after-load 'embark (add-to-list 'embark-target-finders 'citar-citation-finder) (add-to-list 'embark-transformer-alist '(citar-reference . citar--reference-transformer)) (add-to-list 'embark-target-finders 'citar-key-finder))
