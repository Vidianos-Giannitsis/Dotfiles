...
screens = [
	...
	bottom=bar.Bar(
	    [
		widget.CurrentLayout(background="#2a3628"),
		widget.Sep(foreground="#363428", size_percent=100),
		widget.GroupBox(),
		widget.Prompt(),
		widget.WindowName(),
		widget.Sep(foreground="#363428", size_percent=100),
		widget.TextBox("Free Space: ", background="#2a3628"),
		widget.DF(background="#2a3628", visible_on_warn=False, format='({uf}{m}|{r:.0f}%)', warn_space=20),
		widget.Sep(foreground="#363428", size_percent=100),
		widget.TextBox("RAM: ", background="#36282a"),
		widget.Memory(background="#36282a"),
		widget.TextBox(",", background="#36282a"),
		widget.CPU(background="#36282a"),
		widget.TextBox("Battery: ", background="#2a3628"),
		...
		widget.TextBox("", background="#36282a"),
		widget.Clock(format='%a %d-%m-%Y %I:%M %p', background="#36282a"),
		widget.Sep(foreground="#363428", size_percent=100),
		widget.Systray(),
	],
	    24,
