...
# Layouts
layouts = [
    layout.MonadTall(border_focus = "#bd93f9", border_normal = "#002525"),
    # layout.Columns(),
    # layout.Bsp(),
    layout.Max(),
    layout.Stack(num_stacks=2, border_focus = "#bd93f9", border_normal = "#002525"),
    # layout.Matrix(),
    layout.MonadWide(border_focus = "#bd93f9", border_normal = "#002525"),
    # layout.RatioTile(),
